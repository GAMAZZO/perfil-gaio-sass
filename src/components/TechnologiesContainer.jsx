...
const technologies = [
  ...
  { id: "css", name: "CSS3", icon: <DiCss3 />, text:"Ainda há muito de aprender e me exercitar ao usar em diferentes situações. Fico impressionado com o que o Css é capas de fazer, e a cada projeto novo é uma suspresa. Ainda irei ficar muitos anos prandendo, porque realmente é muita coisa, e isso faz do Css ser muito completo." },
